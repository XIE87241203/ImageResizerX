...
const i18n = {
  zh: {
    ...
    compareTitle: '图片对比工具',
    compareSubtitle: '左右对比或叠加对比，快速发现差异',
    leftImage: '左侧图片 (基准)',
    rightImage: '右侧图片 (对比)',
    opacity: '叠加透明度',
    compareMode: '对比模式',
  ...
  en: {
    ...
    imageInfo: '{fileName}: {name} | {size}: {width} × {height} | {fileSize}: {sizeValue}',
    compareTitle: 'Image Comparison Tool',
    compareSubtitle: 'Side-by-side or overlay comparison to spot differences',
